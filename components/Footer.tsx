...
const Footer = () => {
  return (
    <footer className='h-96 w-screen bg-green-600 text-gray-50 text-center flex justify-center items-center text-lg'>
      <div className='flex min-w-1/2 flex-wrap'>
        ...
        <div className='max-w-1/2 m-auto ml-8 w-full'>
          <p className='mb-6'>
            Website Designed and Developed by Silas Cundiff
          </p>
